...
@section('title')
    <title>Edit Sales - Harvest Vape</title>
    ...
    <div class="w-full px-32">
        <div class="card">
            <div class="card-body p-4 mt-20">
                ...
                <p class="-mt-8 mb-5 font-semibold" style="font-size: 15px">Penjualan {{ $sales->kode_sales }}</p>

                <form method="POST" action="{{ route('admin.sales.update', ['id' => $sales->id]) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="flex-fill">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('date_sales') is-invalid @enderror"
                                    id="date_sales" name="date_sales" value="{{ old('date_sales', $sales->date_sales) }}">
                            ...
                            <select class="form-select select2 @error('kode_barang') is-invalid @enderror" id="kodeBarang"
                                ...
                                @foreach ($kodeBarangOptions as $option)
                                    ...
                                    <option
                                        ...
                                        {{ old('kode_barang', $sales->kode_barang . '-' . str_pad($sales->batch, 2, '0', STR_PAD_LEFT)) == $option->kode_barang . '-' . str_pad($option->batch, 2, '0', STR_PAD_LEFT) ? 'selected' : '' }}>
                                        {{ $kodeNamaBarang }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="flex-fill me-3" style="width: 50%">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_barang') is-invalid @enderror"
                                    ...
                                    value="{{ old('nama_barang', $sales->nama_barang) }}">
                                <div class="invalid-feedback">
                                    @error('nama_barang')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="flex-fill me-3" style="width: 25%">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('jumlah_sales') is-invalid @enderror"
                                    ...
                                    value="{{ old('jumlah_sales', $sales->jumlah_sales) }}">
                                <div class="invalid-feedback">
                                    @error('jumlah_sales')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="flex-fill" style="width: 25%">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('harga_barang') is-invalid @enderror"
                                    ...
                                    value="{{ old('harga_barang', $sales->harga_barang) }}">
                                <div class="invalid-feedback">
                                    @error('harga_barang')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="flex-fill">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('harga_potongan') is-invalid @enderror"
                                    id="harga_potongan" name="harga_potongan" placeholder="Harga item"
                                    value="{{ old('harga_potongan', $sales->harga_potongan) }}">
                                <div class="invalid-feedback">
...
@section('js')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Trigger change event on page load to populate fields with selected option data
            kodeBarangSelect.trigger('change');
        });
