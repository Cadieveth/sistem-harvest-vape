        ...
        <div class="card">
            <div class="card-body p-4 mt-20">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="card-title fw-semibold">Form Edit Jurnal Umum</h5>
                ...
                <form method="POST" action="{{ route('admin.journals.update', ['id' => $journal->id]) }}">
                    @csrf
                    @method('PUT')
                    <div class="d-flex">
                        <div class="flex-fill me-3" style="width: 50%">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_jurnal') is-invalid @enderror"
                                    id="tanggal_jurnal" name="tanggal_jurnal"
                                    value="{{ old('tanggal_jurnal', $journal->tanggal_jurnal) }}">
                        ...
                        <div class="flex-fill me-3 mr-3" style="width: 50%">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('ket_jurnal') is-invalid @enderror"
                                    ...
                                    placeholder="Pembelian RillaCake Strawberry Nic 6 60ml"
                                    value="{{ old('ket_jurnal', $journal->ket_jurnal) }}">
                                <div class="invalid-feedback">
                                    @error('ket_jurnal')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('debit_acc_id') is-invalid @enderror" id="debit_acc_id"
                                    ...
                                    @foreach ($account as $row)
                                        <option value="{{ $row->id }}"
                                            {{ old('debit_acc_id', $journal->debit_acc_id) == $row->id ? 'selected' : '' }}>
                        ...
                        <div class="flex-fill me-3" style="width: 65%">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('debit_jurnal') is-invalid @enderror"
                                    ...
                                    value="{{ old('debit_jurnal', $journal->debit_jurnal) }}">
                                <div class="invalid-feedback">
                                    @error('debit_jurnal')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="flex-fill me-3 mr-3" style="width: 35%">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('kredit_acc_id') is-invalid @enderror" id="kredit_acc_id"
                                    ...
                                    @foreach ($account as $row)
                                        <option value="{{ $row->id }}"
                                            {{ old('kredit_acc_id', $journal->kredit_acc_id) == $row->id ? 'selected' : '' }}>
                                            <div class="flex justify-between border border-black">
                                                <div>{{ $row->kode_akun }}</div>
                                                <div>-</div>
                                                <div>{{ $row->nama_akun }}</div>
                        ...
                        <div class="flex-fill me-3" style="width: 65%">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('kredit_jurnal') is-invalid @enderror"
                                    ...
                                    value="{{ old('kredit_jurnal', $journal->kredit_jurnal) }}">
                                <div class="invalid-feedback">
                                    @error('kredit_jurnal')
                                        {{ $message }}
                                    @enderror
